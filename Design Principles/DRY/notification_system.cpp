...
public:
  static string format(const string& category, const string& userId, const string& details) {
...
public:
  void notifyOrderConfirmation(const string& userId, const string& orderId) {
    string message = MessageFormatter::format("Order", userId, "your order " + orderId + " has been confirmed.");
